...
export class AuthService{
    ...
    autologin(){
        ...
        if(loadedUser.token){
            ...
            this.store.dispatch(new AuthActions.Login({email: loadedUser.email, userId: loadedUser.id, token: loadedUser.token, expirationDate: new Date(userData._tokenExpiratorionDate)}))
